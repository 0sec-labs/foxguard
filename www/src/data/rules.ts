...
const jsRules: Rule[] = [
  ...
  { id: 'js/no-unsafe-deserialization', cwe: 'CWE-502', desc: 'Unsafe deserialization can lead to remote code execution', severity: 'critical' },
...
const goRules: Rule[] = [
  ...
  { id: 'go/no-unsafe-deserialization', cwe: 'CWE-502', desc: 'Unsafe deserialization can lead to remote code execution', severity: 'high' },
