...
const jsRules: Rule[] = [
  ...
  { id: 'js/pq-vulnerable-crypto', cwe: 'CWE-327', desc: 'Use of quantum-vulnerable cryptographic algorithm (RSA/ECDSA/ECDH/DH/Ed25519)', severity: 'medium' },
...
const pyRules: Rule[] = [
  ...
  { id: 'py/pq-vulnerable-crypto', cwe: 'CWE-327', desc: 'Use of quantum-vulnerable cryptographic algorithm (RSA/ECDSA/ECDH/DSA/Ed25519/X25519)', severity: 'medium' },
...
const goRules: Rule[] = [
  ...
  { id: 'go/pq-vulnerable-crypto', cwe: 'CWE-327', desc: 'Use of quantum-vulnerable cryptographic algorithm (RSA/ECDSA/ECDH/DSA/Ed25519)', severity: 'medium' },
...
const javaRules: Rule[] = [
  ...
  { id: 'java/pq-vulnerable-crypto', cwe: 'CWE-327', desc: 'Use of quantum-vulnerable cryptographic algorithm (RSA/EC/DSA/DH/Ed25519/X25519)', severity: 'medium' },
...
const rustRules: Rule[] = [
  ...
  { id: 'rs/pq-vulnerable-crypto', cwe: 'CWE-327', desc: 'Use of quantum-vulnerable cryptographic algorithm (RSA/ECDSA/ECDH/Ed25519/X25519)', severity: 'medium' },
