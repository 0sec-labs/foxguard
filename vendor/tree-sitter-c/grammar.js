  ...
  rules: {
    ...
    linkage_specification: $ => choice(
      ...
      seq(
        ...
        'extern',
        field('value', $.string_literal),
        field('body', alias($._guarded_declaration_list, $.declaration_list)),
        preprocessor('endif'),
      ),
    ),

    // Both braces belong to this linkage body even when guarded separately.
    _guarded_declaration_list: $ => seq(
      '{',
      preprocessor('endif'),
